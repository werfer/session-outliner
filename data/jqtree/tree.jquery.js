...
(function() {
  ...
  Node = (function() {
    ...
    Node.prototype.insert = function(node_info, index) {
      var node;
      node = new this.tree.node_class(node_info);
      this.addChildAtPosition(node, index);
      return node;
    };
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype.replaceNode = function(old_node, new_node_info) {
      var new_node, parent_node, position;
      parent_node = old_node.parent;
      if (parent_node) {
        this.select_node_handler.removeFromSelection(old_node, true);
        position = parent_node.getChildIndex(old_node);
        old_node.remove();
        new_node = parent_node.insert(new_node_info, position);
  ...
  BorderDropHint = (function() {
    function BorderDropHint($element) {
      $element.addClass('jqtree-drop-target');
      this.$mElement = $element;
    }

    BorderDropHint.prototype.remove = function() {
      return this.$mElement.removeClass('jqtree-drop-target');
    };
